...
import com.example.simple_mvvm.model.colors.InMemoryColorsRepository.Companion.AVAILABLE_COLORS
...
class InMemoryColorsRepository(private val tasksFactory: TasksFactory): ColorsRepository {
